...
public class FxmTestMain : MonoBehaviour
{
	...
	private void Start()
	{
		...
		if (m_PrefabList != null && 0 < m_PrefabList.transform.childCount)
		{
			...
			CreateCurrentInstanceEffect(bRunAction: true);
		}
	}
	...
	public void ClearCurrentEffectObject(GameObject effectRoot, bool bClearEventObject)
	{
		if (bClearEventObject)
		{
			...
			{
				NgObject.RemoveAllChildObject(instanceRoot, bImmediate: true);
			}
		}
		NgObject.RemoveAllChildObject(effectRoot, bImmediate: true);
	...
	private bool CreateCurrentInstanceEffect(GameObject gameObj)
	{
		...
		if (gameObj != null)
		{
			GameObject gameObject = UnityEngine.Object.Instantiate(gameObj);
